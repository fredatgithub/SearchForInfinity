# Search for Postgresql Infinity values

Here is the roadmap

- [x] Search for `infinity` value in a Postgresql database

This is a WPF application written in C# targetting .NET 4.8

# How to use it

Start the WPF application on your Windows PC.

On the first tab, enter your credentials to log into the PostgreSQL database.
